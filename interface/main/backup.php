...
//
//
// These are configuration variables (note this section will be migrated
//  to the interface/globals.php in future OpenEMR version 3.2 series)
//
// Operating system specific settings
//  Currently use in the Adminstration->Backup page within OpenEMR
//  -Note the temporary file directory parameter is only used when
//    php version is < 5.2.1 (otherwise the temporary directory set
//    within php is used)
//
...
if ($form_step == 0) {
  echo "<table>\n";
  echo " <tr>\n";
  echo "  <td>" . xl('This will create a backup in tar format and then send it to your web browser so you can save it','','','. ') . xl('Press Continue to proceed','','','.') . "</td>\n";
  echo " </tr>\n";
  echo " <tr>\n";
